		...
		<main>
			...
			<section>
				...
				<dl>
					...
					<dd>
						The French have a phrase, <ForeignTerm lang="fr">je ne sais quoi</ForeignTerm>, 
						which means "I don't know what" but implies an indefinable quality.
					</dd>
					
					<dt>Latin phrase with translation</dt>
					<dd>
						The motto <ForeignTerm lang="la" translate="no">carpe diem</ForeignTerm> 
			...
			<section>
				...
				<dl>
					...
					<dd>
						The patient presented with <Jargon field="medical">tachycardia</Jargon> and 
						<Jargon field="medical"> dyspnea</Jargon> on exertion.
					</dd>
					
					<dt>Legal jargon with definition</dt>
					<dd>
						The <Jargon field="legal" title="A written statement confirmed by oath">
							affidavit
						</Jargon> was submitted to the court.
					</dd>
				</dl>
			</section>
			...
			<section>
				...
				<dl>
					...
					<dd>
						<MentionedTerm>Quantum entanglement</MentionedTerm> is a phenomenon where 
					...
					<dd>
						The term <MentionedTerm>algorithm</MentionedTerm> comes from the name of 
						the Persian mathematician Al-Khwarizmi.
					</dd>
				</dl>
			</section>
			...
			<section>
				...
				<dl>
					...
					<dd>
						The act of <Neologism dateCoined="2020">doomscrolling</Neologism> became 
						common during the pandemic.
					</dd>
					
					<dt>Tech neologism with origin</dt>
					<dd>
						<Neologism dateCoined="2008" origin="Satoshi Nakamoto">Bitcoin</Neologism> 
			...
			<section>
				...
				<dl>
					...
					<dd>
						The composer <TransliteratedTerm 
							fromLang="ru" 
							originalScript="Пётр Ильич Чайковский"
						>
							Pyotr Ilyich Tchaikovsky
						</TransliteratedTerm> wrote Swan Lake.
					</dd>
					
					<dt>Japanese transliteration</dt>
					<dd>
						The word <TransliteratedTerm 
							fromLang="ja" 
							originalScript="さようなら"
							system="romaji"
						>
							sayonara
						</TransliteratedTerm> means goodbye.
					</dd>
				</dl>
			</section>
			...
			<section>
				...
				<dl>
					...
					<dd>
						Is it spelled <WordAsWord>grey</WordAsWord> or <WordAsWord>gray</WordAsWord>? 
						Both are correct!
					</dd>
				</dl>
			</section>
			...
			<section>
				...
				<dl>
					...
					<dd>
						<Abbreviation expansion="Doctor">Dr.</Abbreviation> Smith will see you now.
					</dd>
					
					<dt>Acronym (pronounced as word)</dt>
					<dd>
						<Acronym expansion="National Aeronautics and Space Administration">NASA</Acronym> 
						launched another satellite.
					</dd>
					
					<dt>Initialism (spelled out)</dt>
					<dd>
						The <Initialism expansion="Federal Bureau of Investigation">FBI</Initialism> 
						is investigating the case.
					</dd>
					
					<dt>Complex abbreviation</dt>
					<dd>
						Please <Abbreviation expansion="répondez s'il vous plaît" lang="fr">
							RSVP
						</Abbreviation> by Friday.
					</dd>
				</dl>
			</section>
