...
import { TONE, EMOJI } from "~lib/components/semantic/wrappers/constants/index.ts"
	...
	return (
		<main>
			...
			<section>
				...
				<p>Adds emotional tone and ARIA labels to content for better accessibility.</p>
				
				<dl>
					<dt>Happy tone with emoji</dt>
					<dd>
						<WithTone tone={TONE.happy} emoji={EMOJI.happy}>
							I'm so happy to be using this component! It makes my content more expressive.
						</WithTone>
					</dd>
					...
					<dd>
						<WithTone tone={TONE.excited} emoji={EMOJI.excited} className="highlight">
			...
			<section>
				...
				<p>Provides pronunciation guidance for names, technical terms, or unfamiliar words.</p>
				
				<dl>
					<dt>Name pronunciation with IPA</dt>
					<dd>
						My last name is <SpokenAs ipa="/mʌˈnɒt/" phonetic="muh-NAHT">
							Munat
					...
					<dd>
						...
						<SpokenAs phonetic="jiff" ipa="/dʒɪf/"> GIF</SpokenAs> debate will never end.
					</dd>
					
					<dt>Foreign word with both IPA and phonetic</dt>
					<dd>
						The French word <SpokenAs ipa="/kʁwasɑ̃/" phonetic="kwah-SAHN">
							croissant
						</SpokenAs> is often mispronounced in English.
					</dd>
					
					<dt>Place name pronunciation</dt>
					<dd>
						The city of <SpokenAs ipa="/ˈwʊstər/" phonetic="WUSS-ter">
							Worcester
						</SpokenAs> in Massachusetts is notoriously difficult to pronounce.
					</dd>
				</dl>
			</section>
