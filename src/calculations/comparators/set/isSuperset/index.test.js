...
test("[isSuperset] (calculations::comparators::numerical) returns value when sets are disjoint", () => {
	const op = IsSuperset("Set")(Constant("Integer")([1, 2, 3, 4, 5, 6]))(
		Constant("Integer")([4, 5]),
	)
...
test("[isSuperset] (calculations::comparators::numerical) returns an error when sets are not disjoint", () => {
	const op = IsSuperset("Set")(Constant("Integer")([1, 2, 3]))(
		Constant("Integer")([1, 2, 3, 4]),
	)
		...
		left: [
			{
				...
				operation: {
					tag: "IsSuperset",
					datatype: "Set",
					operand: { tag: "Constant", datatype: "Integer", value: [1, 2, 3] },
					test: { tag: "Constant", datatype: "Integer", value: [1, 2, 3, 4] },
				},
				type: "IsSuperset",
			},
		],
