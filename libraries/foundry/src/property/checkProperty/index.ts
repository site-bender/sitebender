import type { Property, PropertyResult, PropertySuccess, Configuration } from "../../types/index.ts"
...
export default function checkProperty<Arguments extends ReadonlyArray<unknown>>(
	...
	return function checkWithConfiguration(config: Configuration = {}): PropertyResult {
