...
║        @sitebender/agent Library Demo          ║
╚════════════════════════════════════════════╝${colors.reset}

${colors.dim}A functional, offline-first agent networking library
...
${colors.cyan}tests/unit/agent/${colors.reset}

${colors.dim}Or read the source code in:${colors.reset}
${colors.cyan}libraries/agent/src/${colors.reset}
`)
}
