...
> 
> This file is automatically generated from `libraries/mesh/rules/index.json`.
> To make changes, edit the JSON file and run `deno task generate-rules`.

**Version**: 1.0.0  
**Last updated**: 2025-01-12  
**Author**: The Architect  
**Scope**: libraries/mesh  
**Description**: Rules specific to the Mesh library - distributed, offline-first data  
