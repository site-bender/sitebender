...
async function parseWithSemantics(
	sourceText: string,
	filePath: string,
): Promise<SemanticAst> {
	try {
		...
		const semanticAst: SemanticAst = {
			...
			semanticInfo: convertWasmSemanticInfo(wasmResult["semantic_info"]),
		}
...
function convertWasmSemanticInfo(wasmInfo: WasmSemanticInfo): SemanticInfo {
