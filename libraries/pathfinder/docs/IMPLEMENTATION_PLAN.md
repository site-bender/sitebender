...
- [ ] 2. Write tests FIRST (index.test.ts)
- [ ] 3. Test success: returns list of collections
- [ ] 4. Test error: connection fails
- [ ] 5. Test edge: empty list
- [ ] 6. Verify tests fail (no implementation)
- [ ] 7. Consult `function-implementation` skill
- [ ] 8. Consult `error-handling` skill
- [ ] 9. Implement function
- [ ] 10. Use Toolsmith `map` to transform results
- [ ] 11. Mark with `// [IO]` comment
- [ ] 12. Return `Io<Promise<Result<...>>>` if needed
- [ ] 13. Extract any helpers to `_transformCollectionList/` if needed
- [ ] 14. Run `deno task test`
- [ ] 15. Confirm 100% tests pass
- [ ] 16. Verify tests check actual functionality
- [ ] 17. Run `deno task test:strict` (no --no-check!)
- [ ] 18. Run `deno task lint`
- [ ] 19. Run `deno task fmt`
- [ ] 20. Check coverage 100%
- [ ] 21. Add JSDoc comments
- [ ] 22. Document any helpers
- [ ] 23. Add usage example in comments
- [ ] 24. Verify no `class` keywords
- [ ] 25. Verify no arrow functions
- [ ] 26. Verify no loops
- [ ] 27. Verify no mutations
- [ ] 28. Verify using Toolsmith operators
- [ ] 29. Verify proper currying (one param)
- [ ] 30. Verify helpers in `_subfolder/`
- [ ] 31. Mark batch complete
- [ ] 32. Note any issues
...
**Phase 1 (Critical Qdrant): 0/6 Complete**
- [ ] listCollections
- [ ] getCollectionInfo
- [ ] deleteCollection
- [ ] retrievePoints
...
### Total Progress: 0/31 Operations (0%)
