...
import type { InjectorNode, OperatorNode, ComparatorNode } from "../../../../types/ir/index.ts"
...
const injector = (value: unknown): InjectorNode => ({ v: "0.1.0", kind: 'injector', id: nodeId(), injector: 'From.Constant', datatype: 'String', args: { value } })
const opAdd = (args: Array<InjectorNode | OperatorNode>): OperatorNode => ({ v: "0.1.0", kind: 'operator', id: nodeId(), op: 'Op.Add', datatype: 'Float', args })
const cmpEq = (a: InjectorNode | OperatorNode, b: InjectorNode | OperatorNode): ComparatorNode => ({ v: "0.1.0", kind: 'comparator', id: nodeId(), cmp: 'Is.EqualTo', args: [a, b] })
