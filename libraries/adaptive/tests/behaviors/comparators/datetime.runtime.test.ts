...
Deno.test("DateTime comparators runtime IsSame/Not*", async () => {
  ...
  assertEquals(
    await evaluateNode(cmp("IsSameDateTime", "2024-05-01T12:00", "2024-05-01T12:00"), ctx),
    true,
  )
  assertEquals(
    await evaluateNode(cmp("IsNotAfterDateTime", "2024-05-01T12:00", "2024-05-01T12:00"), ctx),
    true,
  )
  assertEquals(
    await evaluateNode(cmp("IsNotBeforeDateTime", "2024-05-01T12:00", "2024-05-01T12:00"), ctx),
    true,
  )
})
