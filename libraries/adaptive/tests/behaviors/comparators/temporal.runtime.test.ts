...
Deno.test("Temporal Date comparators runtime", async () => {
	...
	assertEquals(
		await evaluateNode(cmp("IsAfterDate", "2024-05-02", "2024-05-01"), ctx),
		true,
	)
	assertEquals(
	...
	assertEquals(
		await evaluateNode(cmp("IsSameDate", "2024-05-01", "2024-05-01"), ctx),
		true,
	)
	assertEquals(
...
Deno.test("Temporal Time comparators runtime", async () => {
	...
	assertEquals(
		await evaluateNode(cmp("IsAfterTime", "12:01", "12:00"), ctx),
		true,
	)
	assertEquals(
		await evaluateNode(cmp("IsBeforeTime", "11:59", "12:00"), ctx),
		true,
	)
	assertEquals(
		await evaluateNode(cmp("IsSameTime", "12:00", "12:00"), ctx),
		true,
	)
	assertEquals(
		await evaluateNode(cmp("IsNotAfterTime", "12:00", "12:00"), ctx),
		true,
	)
	assertEquals(
		await evaluateNode(cmp("IsNotBeforeTime", "12:00", "12:00"), ctx),
		true,
	)
	assertEquals(
		await evaluateNode(cmp("IsNotSameTime", "12:00", "12:01"), ctx),
		true,
	)
})
...
Deno.test("Temporal DateTime comparators runtime", async () => {
	...
	assertEquals(
		await evaluateNode(
			cmp("IsAfterDateTime", "2024-05-01T12:01", "2024-05-01T12:00"),
			ctx,
		),
		true,
	)
	assertEquals(
		await evaluateNode(
			cmp("IsBeforeDateTime", "2024-05-01T11:59", "2024-05-01T12:00"),
			ctx,
		),
		true,
	)
