 ...
 */
export default function flatMapDescendants(children: readonly unknown[]): readonly string[] {
    const reducer = (out: string[], child: unknown): string[] => {
		if (typeof child === "object" && child !== null && "tag" in (child as Record<string, unknown>)) {
