...
import type { Node, InjectorNode, OperatorNode, ComparatorNode } from "../../../types/ir/index.ts"
...
export default async function evaluate(node: Node, ctx: ComposeContext): Promise<unknown> {
  switch (node.kind) {
    case "injector": {
