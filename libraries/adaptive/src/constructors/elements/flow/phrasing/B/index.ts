...
import type { BringAttentionToAttributes } from "@adaptiveSrc/constructors/elements/types/attributes/index.ts"
 ...
 */
export const filterAttributes = (attributes: BElementAttributes) => {
	const {
		id,
		// ARIA attributes
 ...
 * ```
 */
export const B = (attributes: BElementAttributes = {}) =>
(
