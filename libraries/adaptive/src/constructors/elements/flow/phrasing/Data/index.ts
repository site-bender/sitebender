...
import type { DataAttributes } from "@adaptiveSrc/constructors/elements/types/attributes/index.ts"
 ...
 */
export const filterAttributes = (attributes: DataElementAttributes) => {
	const {
		id,
		value,
		// ARIA attributes
 ...
 * ```
 */
export const Data = (attributes: DataElementAttributes) =>
(
