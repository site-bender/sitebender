...
import type { DefinitionAttributes } from "../../../types/attributes/index.ts"
 ...
 */
export const filterAttributes = (attributes: DfnElementAttributes) => {
	const {
		id,
		// ARIA attributes
 ...
 * ```
 */
export const Dfn = (attributes: DfnElementAttributes = {}) =>
(
