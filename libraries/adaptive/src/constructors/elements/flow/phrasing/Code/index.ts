...
import type { CodeAttributes } from "@adaptiveSrc/constructors/elements/types/attributes/index.ts"
 ...
 */
export const filterAttributes = (attributes: CodeElementAttributes) => {
	const {
		id,
		// ARIA attributes
 ...
 * ```
 */
export const Code = (attributes: CodeElementAttributes = {}) =>
(
