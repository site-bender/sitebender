import type { FromArgumentInjector } from "../../../../../engine/types/index.ts"
...
import FromArgumentConstructor from "../../../../../engine/src/constructors/injectors/FromArgument/index.ts"
