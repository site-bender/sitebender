...
export default function FromStore({ key, type = "String", datatype, defaultValue }: FromStoreProps): InjectorShape {
  const dt = (datatype as DataType | undefined) ?? (type === "Number" ? "Float" : (type as unknown as DataType))
