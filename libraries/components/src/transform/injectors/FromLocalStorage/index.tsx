import type { FromLocalStorageInjector } from "../../../../../engine/types/index.ts"
...
import FromLocalStorageConstructor from "../../../../../engine/src/constructors/injectors/FromLocalStorage/index.ts"

export type FromLocalStorageProps = {
	key: string
	type?: "String" | "Number" | "Boolean" | "Json"
	datatype?: "String" | "Number" | "Boolean" | "Json"
	defaultValue?: import("../../../../../engine/types/index.ts").Value
}
