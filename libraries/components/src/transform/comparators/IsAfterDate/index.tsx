import type { IsAfterDateComparator, Operand } from "@sitebender/engine-types/index.ts"
...
import IsAfterDateConstructor from "@sitebender/engine/constructors/comparators/date/IsAfterDate/index.ts"
