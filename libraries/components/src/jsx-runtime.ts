...
export function jsx(type: string | ((props: Record<string, unknown>) => unknown), props: Record<string, unknown>, key?: string | number) {
	const { children, ...rest } = props ?? {}
	const next = key !== undefined && key !== null ? { ...rest, key } : rest
	return createElement(type, next, children)
}

export function jsxs(type: string | ((props: Record<string, unknown>) => unknown), props: Record<string, unknown>, key?: string | number) {
