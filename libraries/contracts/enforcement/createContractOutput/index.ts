import type { ContractMetadata, ContractOutput } from "../types/index.ts"

import { DEFAULT_HASH_ALGORITHM, HASH_VERSION } from "../constants/index.ts"

import hashHex from "../../../../toolkit/src/crypto/hashHex/index.ts"
...
export default async function createContractOutput<T>(
	...
	const dataJson = JSON.stringify(frozenData)
