...
- **Function signatures**: Extracted from actual TypeScript AST (via Parser)
...
- **Immutable contract**: Parser does ALL TypeScript compilation

### **With Prover Library**
- **Test coverage integration**: Show which functions have 100% coverage
- **Property verification**: Prover generates tests for mathematical laws
