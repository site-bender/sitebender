//++ Public types exported by the Parser library - contract compliant

import type { ContractOutput } from "../../../contracts/enforcement/types"
...
export type ParserContractOutput<T> = ContractOutput<T>