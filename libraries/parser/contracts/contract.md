# Parser Library Contract v1.0.0
...
Wrapper for all Parser outputs ensuring contract compliance
...
> **Note:** Parser does NOT interpret comment syntax (//++, //--, etc). That is Envoy's responsibility.
...
- ✅ Import ts-morph
- ✅ Read file system
- ✅ Use Foundry for test data generation
...
### Forbidden from consuming Parser output:
