...
export default function _flatMapArray<T, U>(f: (arg: T, index?: number) => ReadonlyArray<U>) {
	return function _flatMapArrayWithFunction(array: ReadonlyArray<T>): ReadonlyArray<U> {
