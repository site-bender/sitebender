...
import subtractTwoDecimalPlaces from "./index.ts"

Deno.test("subtractTwoDecimalPlaces", async (t) => {
	await t.step("subtracts two positive exact two decimal values", () => {
		const minuend = 10.25 as TwoDecimalPlaces
		const subtrahend = 5.5 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("subtracts resulting in negative value", () => {
		const minuend = 5.5 as TwoDecimalPlaces
		const subtrahend = 10.25 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("subtracts negative value (equivalent to addition)", () => {
		const minuend = 10.5 as TwoDecimalPlaces
		const subtrahend = -3.25 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("subtracts from negative value", () => {
		const minuend = -10.5 as TwoDecimalPlaces
		const subtrahend = 5.25 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("handles subtraction with zero", () => {
		const minuend = 10.5 as TwoDecimalPlaces
		const subtrahend = 0 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("handles subtraction resulting in zero", () => {
		const minuend = 10.5 as TwoDecimalPlaces
		const subtrahend = 10.5 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("handles very small values", () => {
		const minuend = 0.05 as TwoDecimalPlaces
		const subtrahend = 0.03 as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
	...
	await t.step("returns error when result is not finite", () => {
		const minuend = -Number.MAX_VALUE as TwoDecimalPlaces
		const subtrahend = Number.MAX_VALUE as TwoDecimalPlaces
		const result = subtractTwoDecimalPlaces(minuend)(subtrahend)
