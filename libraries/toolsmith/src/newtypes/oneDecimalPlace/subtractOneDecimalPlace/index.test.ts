...
import subtractOneDecimalPlace from "./index.ts"

Deno.test("subtractOneDecimalPlace", async (t) => {
	await t.step("subtracts two positive exact one decimal values", () => {
		const minuend = 10.2 as OneDecimalPlace
		const subtrahend = 5.5 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("subtracts resulting in negative value", () => {
		const minuend = 5.5 as OneDecimalPlace
		const subtrahend = 10.2 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("subtracts negative value (equivalent to addition)", () => {
		const minuend = 10.5 as OneDecimalPlace
		const subtrahend = -3.2 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("subtracts from negative value", () => {
		const minuend = -10.5 as OneDecimalPlace
		const subtrahend = 5.2 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("handles subtraction with zero", () => {
		const minuend = 10.5 as OneDecimalPlace
		const subtrahend = 0 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("handles subtraction resulting in zero", () => {
		const minuend = 10.5 as OneDecimalPlace
		const subtrahend = 10.5 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("handles very small values", () => {
		const minuend = 0.5 as OneDecimalPlace
		const subtrahend = 0.3 as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
	...
	await t.step("returns error when result is not finite", () => {
		const minuend = -Number.MAX_VALUE as OneDecimalPlace
		const subtrahend = Number.MAX_VALUE as OneDecimalPlace
		const result = subtractOneDecimalPlace(minuend)(subtrahend)
