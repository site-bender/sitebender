...
export default function uri(
	...
	//++ [EXCEPTION] .indexOf(), .slice() permitted in Toolsmith for performance - provides URI parsing wrapper
	...
	//++ [EXCEPTION] .filter(), Math.min(), spread operator permitted in Toolsmith for performance - provides URI component extraction wrapper
