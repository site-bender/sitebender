...
Deno.test("_validateIriAuthority validates correct authorities", async function (t) {
...
Deno.test("_validateIriAuthority rejects invalid authorities", async function (t) {
