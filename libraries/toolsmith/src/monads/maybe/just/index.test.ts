...
Deno.test("just", async function justTests(t) {
	await t.step(
		"creates a Just with number value",
		function createsJustNumber() {
	...
	await t.step(
		"creates a Just with string value",
		function createsJustString() {
	...
	await t.step(
		"creates a Just with object value",
		function createsJustObject() {
	...
	await t.step(
		"creates a Just with undefined value",
		function createsJustUndefined() {
	...
	await t.step(
		"creates a Just with boolean value",
		function createsJustBoolean() {
