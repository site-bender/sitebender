...
Deno.test("left", async function leftTests(t) {
	await t.step(
		"creates a Left with string value",
		function createsLeftString() {
	...
	await t.step(
		"creates a Left with number value",
		function createsLeftNumber() {
	...
	await t.step(
		"creates a Left with object value",
		function createsLeftObject() {
	...
	await t.step(
		"creates a Left with undefined value",
		function createsLeftUndefined() {
