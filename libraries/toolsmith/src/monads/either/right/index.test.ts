...
Deno.test("right", async function rightTests(t) {
	await t.step("creates a Right with number value", function createsRightNumber() {
	...
	await t.step("creates a Right with string value", function createsRightString() {
	...
	await t.step("creates a Right with object value", function createsRightObject() {
	...
	await t.step("creates a Right with boolean value", function createsRightBoolean() {
	...
	await t.step("creates a Right with array value", function createsRightArray() {
	...
	await t.step("creates a Right with undefined value", function createsRightUndefined() {
