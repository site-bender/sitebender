			...
			return {
				...
				current: {
					...
					lines: {
						...
						hit: hitCount > 0
							? acc.current.lines.hit + 1
							: acc.current.lines.hit,
						details: [...acc.current.lines.details, {
							line: lineNum,
							hit: hitCount,
						}],
					},
			...
			return {
				...
				current: {
					...
					branches: {
						...
						hit: taken > 0
							? acc.current.branches.hit + 1
							: acc.current.branches.hit,
						details: [...acc.current.branches.details, {
							line: lineNum,
							branch,
							taken,
						}],
