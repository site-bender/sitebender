 ...
 * Logician CLI
 *
 * Command-line interface for the @sitebender/logician test generation library
 *
 * Usage:
 *   deno run --allow-all libraries/logician/src/cli/index.ts [options]
 *
 * Or with task:
 *   deno task logician:generate
 */
...
export default async function runCli(): Promise<void> {
	console.log("🚀 @sitebender/logician - Test Generator CLI")
