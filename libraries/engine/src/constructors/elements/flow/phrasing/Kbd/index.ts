...
import type { KeyboardInputAttributes } from "@adaptiveSrc/constructors/elements/types/attributes/index.ts"
 ...
 */
export const filterAttributes = (attributes: KbdElementAttributes) => {
	const {
		id,
		// ARIA attributes
