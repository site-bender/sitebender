...
describe("Act.If behavior", () => {
    ...
    `
		...
		const { document, window } = createTestDomWithBody(body) // Ensure bus/event infrastructure binds to this test DOM
		 // deno-lint-ignore no-explicit-any
		;(globalThis as any).document = document as unknown as Document // deno-lint-ignore no-explicit-any
