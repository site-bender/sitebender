...
import type { LegendAriaAttributes } from "@sitebender/architect/constructors/elements/types/aria/index.ts"
import type { GlobalAttributes } from "@sitebender/architect/constructors/elements/types/attributes/index.ts"
...
(
	...
	const kids = isString(children)
		...
		? children.filter(ADVANCED_FILTERS.legendContent)
		: ADVANCED_FILTERS.legendContent(children)
		? [children]
		: []
