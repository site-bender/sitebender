...
import type { HeadingAriaAttributes } from "@sitebender/architect/constructors/elements/types/aria/index.ts"
import type { HeadingAttributes } from "@sitebender/architect/constructors/elements/types/attributes/index.ts"
...
/**
 * Extended H3 attributes including reactive properties and ARIA
 */
export type H3ElementAttributes = HeadingAttributes & HeadingAriaAttributes & {
	calculation?: Operand
 ...
 * @example
 * ```typescript
 * const h3 = H3({ id: "sub-title", role: "tab" })([
 *   TextNode("Sub Heading")
 * ])
 * ```
 */
const H3 = (attributes: H3ElementAttributes = {}) =>
(
