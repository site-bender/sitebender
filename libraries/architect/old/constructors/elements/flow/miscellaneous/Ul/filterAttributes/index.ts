import { UL_ROLES } from "@sitebender/architect/constructors/elements/constants/aria-roles.ts"
...
import type { UlElementAttributes } from "../index.ts"

export default function filterAttributes(attributes: UlElementAttributes) {
	const {
		id,
		// ARIA attributes
