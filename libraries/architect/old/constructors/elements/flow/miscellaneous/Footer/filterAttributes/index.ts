import { FOOTER_NOT_IN_SECTIONING_ROLES } from "@sitebender/architect/constructors/elements/constants/aria-roles.ts"
...
import type { FooterElementAttributes } from "../index.ts"

export default function filterAttributes(attributes: FooterElementAttributes) {
	const {
		id,
		// ARIA attributes
