import type { Singleton, Pair, Triple } from "../../../types/tuple/index.ts"
 ...
 */
function fromArray(size: 1): <T>(array: ReadonlyArray<T> | null | undefined) => Singleton<T> | null
function fromArray(size: 2): <T>(array: ReadonlyArray<T> | null | undefined) => Pair<T, T> | null
function fromArray(size: 3): <T>(array: ReadonlyArray<T> | null | undefined) => Triple<T, T, T> | null
