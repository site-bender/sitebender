...
export default function isFutureDateTime(value: DateTimeInput | null | undefined) {
	return function checkFutureDateTime(): boolean {
 ...
 * const validateMeeting = isFutureDateTime(meetingTime)
 * validateMeeting() // true if meeting is in future
 *
