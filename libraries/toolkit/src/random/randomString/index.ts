...
const randomString = (
	...
	charset: string | null | undefined = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'
): string => {
	if (length == null || typeof length !== 'number' || length <= 0 || !isFinite(length)) {
		return ''
	}
