# Toolkit Monads Refactor Tracker
...
- Validation module (locked): `libraries/toolkit/src/monads/validation/`
  - README: `libraries/toolkit/src/monads/validation/README.md`
...
deno task lint
# Toolkit tests only
deno task --cwd libraries/toolkit test
# Or strict toolkit tests
deno task test:toolkit:strict
```
...
# Limit scope
deno run -A scripts/codemods/migrateEnvoyPipeBlocks/index.ts libraries/toolkit/src/monads
```
...
- Keep property-based tests light; they’re temporary until Prover lands.
...
Maintenance tip: In future sessions, tell me to “open `libraries/toolkit/docs/monads-refactor-tracker.md` and continue.” I’ll use this checklist and log to pick up exactly where we left off.
