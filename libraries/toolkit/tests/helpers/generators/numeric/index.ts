 ...
 */
export const finiteNumber = () => fc.float({
	noNaN: true,
 ...
 */
export const nullableNumber = () => fc.oneof(
	fc.constant(null),
 ...
 */
export const edgeCaseNumber = () => fc.oneof(
	fc.constant(0),
	fc.constant(-0),
	fc.constant(NaN),
 ...
 */
export const safeInteger = () => fc.integer({
 ...
 */
export const positiveNumber = () => fc.float({
 ...
 */
export const negativeNumber = () => fc.float({
	min: Math.fround(-1e10),
