...
12. [Envoy Comments](#envoy-comments)
13. [Cognitive Load](#cognitive-load)
14. [The Sacred Oath](#the-sacred-oath)
15. [Final Warnings](#final-warnings)
...
### [no-delete-without-permission] Thou shalt not delete files without explicit permission

- No git clean without written consent
- No rm -rf cowboy operations
- Recovery isn't always possible

### [no-tech-debt] Thou shalt not create tech debt

- No 'fix later' comments
- No temporary workarounds
- No shortcuts, ever

### [test-behaviors] Thou shalt test behaviors, not implementations

- Users don't care about your private methods
- They care if the button works

### [functional-programming] Thou shalt maintain strict functional programming

- No classes, no exceptions
- Immutable data only
- Pure functions (except explicit I/O)

### [single-responsibility] Thou shalt organize by single responsibility

- One function per file
- One thing done well
- Composition over complexity

### [envoy-documentation] Thou shalt document with Envoy comments

- Every function, every time
- Examples included
- Follow the Envoy spec precisely

### [atomic-commits] Thou shalt commit atomically
...
### [ask-when-uncertain] Thou shalt ask when uncertain

- Better to ask than assume
- Better to clarify than cleanup
- Better to be slow and right

### [no-web-components] Thou shalt NEVER use Web Components
...
**Rule**: ONLY Parser and Mesh can reach outside the project

- **Parser**: Can import TypeScript compiler ONLY
- **Mesh**: Can connect to distributed services (IPFS, Solid, etc.)
- **All Others**: ZERO external dependencies. NO EXCEPTIONS.
...
See libraries/envoy/docs/comment-syntax-guide.md for complete guide
