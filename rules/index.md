...
<dd>These aren't preferences - they're engineering decisions based on how human brains process information</dd>
</div>
<div>
...
**Not personal taste**: This is NOT 'personal preference' - cognitive load is MEASURABLE. These are engineering decisions based on how human brains process visual information.
...
<dd>libraries/toolkit/src/vanilla/string/chomp/index.ts</dd>
</div>
<div>
...
<dd>ONLY Parser and Mesh can reach outside the project</dd>
</div>
<div>
...
<div>
<dt><strong>Note</strong></dt>
<dd>These are THROWAWAY tests until Prover is ready to generate all tests</dd>
</div>
<div>
...
<dd>For NEW functions/components, write test TDD style: test FIRST, then function to pass</dd>
</div>
<div>
<dt><strong>Existing code</strong></dt>
<dd>For functions/components we EDIT or fix, write test BEFORE doing the fix</dd>
</div>
<div>
...
**No loops**: No for/while loops - use toolkit functions (map, filter, reduce, etc.)
...
<dd>Loops are imperative - use map, filter, reduce, etc. from toolkit. Loop exception requires: 1) PROVEN bottleneck via profiling, 2) MEASURED improvement with loop, 3) NO functional alternative works, 4) Explicit Architect approval. This bar is nearly impossible to meet - goal is ZERO loops.</dd>
</div>
<div>
...
<dd>Parser reads TypeScript/JSX files and extracts raw comments</dd>
</div>
<div>
...
<div>
<dt><strong>Toolkit functions</strong></dt>
