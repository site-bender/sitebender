...
test("[doesNotMatch] (calculations::comparators::numerical) returns value when an integer", async () => {
	expect(
...
test("[doesNotMatch] (calculations::comparators::numerical) returns an error when not an integer", async () => {
	expect(
