...
test("[isAfterDateTime] (calculations::comparators::date) returns an error when not after date", () => {
	expect(
		isAfterDateTime(
...
test("[isAfterDateTime] (calculations::comparators::date) returns an error when same date", () => {
	expect(
		isAfterDateTime(
