...
test("[isDuration] (calculations::comparators::scalar) returns value when a duration", async () => {
	expect(
...
test("[isDuration] (calculations::comparators::scalar) returns an error when not a duration", async () => {
	expect(
