...
test("[isInstant] (calculations::comparators::scalar) returns value when an instant", () => {
	expect(
		isInstant(
...
test("[isInstant] (calculations::comparators::scalar) returns an error when not an instant", () => {
	expect(isInstant(IsInstant(Constant("String")("Bob")))()).toMatchObject({
		left: [
			{
				tag: "Error",
