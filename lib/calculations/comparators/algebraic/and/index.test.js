...
test("[and] (calculations::comparators::algebraic) returns Right if all operands are Rights", () => {
	expect(
		and(
			And("Number")([
...
test("[and] (calculations::comparators::algebraic) returns Left if any operand is a Left", () => {
	expect(
		and(
			And("Number")([
				Constant("Boolean")(true),
