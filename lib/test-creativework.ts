...
async function testCreativeWorkTransformation(): Promise<void> {
	...
	console.log("🎯 Testing transformation on CreativeWork ONLY")
	console.log(`📁 File: ${creativeworkFile}`)
	console.log("")
	...
	if (!typeInfo) {
		console.log("❌ Could not parse CreativeWork file")
		return
	}
	...
	console.log("📄 ORIGINAL CONTENT (first 20 lines):")
