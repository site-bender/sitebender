...
function calculateRelativeTime(date: Date, relativeTo: Date): { value: number; unit: Intl.RelativeTimeFormatUnit } {
...
function calculateForcedUnit(date: Date, relativeTo: Date, unit: Intl.RelativeTimeFormatUnit): number {
	const diffMs = date.getTime() - relativeTo.getTime()
