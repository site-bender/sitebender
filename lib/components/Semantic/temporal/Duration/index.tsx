...
function toISO8601(duration: DurationValue): string {
	...
	if (hasTime) {
		...
		if (duration.seconds || duration.milliseconds || duration.microseconds || duration.nanoseconds) {
...
function roundDuration(duration: DurationValue, roundTo: string): DurationValue {
