...
type InputActionConstraints<T extends ActionBase> = Partial<
	{
		[K in Exclude<keyof T, `@${string}`> as `${string & K}-input`]:
...
type OutputActionConstraints<T extends ActionBase> = Partial<
	{
		[K in Exclude<keyof T, `@${string}`> as `${string & K}-output`]:
			| PropertyValueSpecification
			| string
	}
>
/** Provides input and output action constraints for an action. */
export type WithActionConstraints<T extends ActionBase> =
	& T
	& InputActionConstraints<T>
	& OutputActionConstraints<T>
...
export type AllocateAction =
	...
	| AuthorizeAction
	| RejectAction
interface AmpStoryBase extends MediaObjectBase, CreativeWorkBase {
}
...
export type BroadcastFrequencySpecification =
	BroadcastFrequencySpecificationLeaf
...
interface CertificationBase extends CreativeWorkBase {
	...
	"certificationIdentification"?: SchemaValue<
	...
	"certificationRating"?: SchemaValue<
		Rating | IdReference,
		"certificationRating"
	>
	...
	"certificationStatus"?: SchemaValue<
		CertificationStatusEnumeration | IdReference,
		"certificationStatus"
	>
...
interface CooperativeLeaf extends OrganizationBase {
	"@type": "Cooperative"
}
/** An organization that is a joint project of multiple organizations or persons. */
export type Cooperative = CooperativeLeaf | string
...
interface CreativeWorkBase extends ThingBase {
	...
	"digitalSourceType"?: SchemaValue<
		IPTCDigitalSourceEnumeration | IdReference,
		"digitalSourceType"
	>
 ...
 *
 * @deprecated Use ShippingConditions instead.
 */
...
interface DemandBase extends ThingBase {
	...
	"acceptedPaymentMethod"?: SchemaValue<
		LoanOrCredit | PaymentMethod | Text | IdReference,
...
export type EducationalOccupationalCredential =
	EducationalOccupationalCredentialLeaf
...
export type EducationalOccupationalProgram =
	| EducationalOccupationalProgramLeaf
	| WorkBasedProgram
interface EducationalOrganizationBase
	extends OrganizationBase, CivicStructureBase {
...
interface FinancialIncentiveBase extends ThingBase {
	/** The geographic area where a service or offered item is provided. */
	"areaServed"?: SchemaValue<
		AdministrativeArea | GeoShape | Place | Text | IdReference,
		"areaServed"
	...
	"eligibleWithSupplier"?: SchemaValue<
		Organization | IdReference,
	 ...
	 * In summary:
	 * - Use {@link https://schema.org/QuantitativeValue QuantitativeValue} for absolute/percentage-based incentives applied on the price of a good/service.
	 *
	 * - Use [[UnitPriceSpecification]] for incentives based on a per-unit basis (e.g. net metering).
	 * - Use [[LoanOrCredit]] for loans/credits.
	 * .
	 */
	"incentiveAmount"?: SchemaValue<
		LoanOrCredit | QuantitativeValue | UnitPriceSpecification | IdReference,
		"incentiveAmount"
	>
	/** The status of the incentive (active, on hold, retired, etc.). */
	"incentiveStatus"?: SchemaValue<
		IncentiveStatus | IdReference,
		"incentiveStatus"
	>
	/** The type of incentive offered (tax credit/rebate, tax deduction, tax waiver, subsidies, etc.). */
	"incentiveType"?: SchemaValue<IncentiveType | IdReference, "incentiveType">
	/**
	 ...
	 */
	"incentivizedItem"?: SchemaValue<
		DefinedTerm | Product | IdReference,
		"incentivizedItem"
	>
	/**
	...
	"purchasePriceLimit"?: SchemaValue<
		MonetaryAmount | IdReference,
		"purchasePriceLimit"
	>
	/** Optional. The type of purchase the consumer must make in order to qualify for this incentive. */
	"purchaseType"?: SchemaValue<PurchaseType | IdReference, "purchaseType">
	...
	"qualifiedExpense"?: SchemaValue<
		IncentiveQualifiedExpenseType | IdReference,
		"qualifiedExpense"
	>
	/** The date when the item becomes valid. */
	"validFrom"?: SchemaValue<Date | DateTime, "validFrom">
...
interface FinancialIncentiveLeaf extends FinancialIncentiveBase {
 ...
 */
export type FinancialIncentive = FinancialIncentiveLeaf
...
interface FulfillmentTypeEnumerationLeaf extends EnumerationBase {
	"@type": "FulfillmentTypeEnumeration"
}
/** A type of product fulfillment. */
export type FulfillmentTypeEnumeration =
	...
	| FulfillmentTypeEnumerationLeaf
...
export type HealthPlanCostSharingSpecification =
	HealthPlanCostSharingSpecificationLeaf
...
interface HospitalBase
	extends LocalBusinessBase, CivicStructureBase, MedicalOrganizationBase {
...
interface IncentiveQualifiedExpenseTypeLeaf extends EnumerationBase {
...
export type IncentiveQualifiedExpenseType =
	...
	| IncentiveQualifiedExpenseTypeLeaf
interface IncentiveStatusLeaf extends EnumerationBase {
...
export type IncentiveStatus =
	...
	| IncentiveStatusLeaf
interface IncentiveTypeLeaf extends EnumerationBase {
	"@type": "IncentiveType"
}
...
interface InvoiceBase extends ThingBase {
	...
	"paymentMethod"?: SchemaValue<
		PaymentMethod | Text | IdReference,
		"paymentMethod"
	>
...
export type IPTCDigitalSourceEnumeration =
	...
	| IPTCDigitalSourceEnumerationLeaf
...
interface ItemListBase extends ThingBase {
	...
	"aggregateElement"?: SchemaValue<Thing | IdReference, "aggregateElement">
	/**
...
export type LandmarksOrHistoricalBuildings =
	| LandmarksOrHistoricalBuildingsLeaf
	| string
...
interface LegislationBase extends CreativeWorkBase {
	...
	"legislationCommences"?: SchemaValue<
		Legislation | IdReference,
	...
	>
	/** Another legislation in which this one introduces textual changes, like correction of spelling mistakes, with no legal impact (for modifications that have legal impact, use {@link /legislationAmends legislationAmends}). */
	"legislationCorrects"?: SchemaValue<
		Legislation | IdReference,
		"legislationCorrects"
	>
	...
	"legislationCountersignedBy"?: SchemaValue<
		Organization | Person | IdReference,
	...
	"legislationDateOfApplicability"?: SchemaValue<
		Date,
	...
	/** Indicates that this Legislation ensures the implementation of another Legislation, for example by modifying national legislations so that they do not contradict to an EU regulation or decision. This implies a legal meaning. Transpositions of EU Directive should be captured with {@link /legislationTransposes legislationTransposes}. */
	"legislationEnsuresImplementationOf"?: SchemaValue<
		Legislation | IdReference,
	...
	"legislationRepeals"?: SchemaValue<
		Legislation | IdReference,
		"legislationRepeals"
	>
...
export type MediaEnumeration =
	| MediaEnumerationLeaf
...
export type MedicalGuidelineContraindication =
	MedicalGuidelineContraindicationLeaf
...
interface MemberProgramTierBase extends ThingBase {
	...
	"hasTierBenefit"?: SchemaValue<
		TierBenefitEnumeration | IdReference,
		"hasTierBenefit"
	>
	...
	"hasTierRequirement"?: SchemaValue<
		CreditCard | MonetaryAmount | Text | UnitPriceSpecification | IdReference,
		"hasTierRequirement"
	>
...
interface MerchantReturnPolicyBase extends ThingBase {
	...
	"validForMemberTier"?: SchemaValue<
		MemberProgramTier | IdReference,
		"validForMemberTier"
	>
}
...
export type MerchantReturnPolicySeasonalOverride =
	MerchantReturnPolicySeasonalOverrideLeaf
...
interface OfferShippingDetailsBase extends ThingBase {
	...
	"hasShippingService"?: SchemaValue<
		ShippingService | IdReference,
		"hasShippingService"
	>
	/** The height of the item. */
	"height"?: SchemaValue<Distance | QuantitativeValue | IdReference, "height">
	...
	"shippingRate"?: SchemaValue<
		MonetaryAmount | ShippingRateSettings | IdReference,
		"shippingRate"
	>
	...
	"weight"?: SchemaValue<Mass | QuantitativeValue | IdReference, "weight">
	/** The width of the item. */
	"width"?: SchemaValue<Distance | QuantitativeValue | IdReference, "width">
}
...
interface OrganizationBase extends ThingBase {
	...
	"agentInteractionStatistic"?: SchemaValue<
		InteractionCounter | IdReference,
	...
	"companyRegistration"?: SchemaValue<
		Certification | IdReference,
		"companyRegistration"
	>
	/** A contact point for a person or organization. */
	"contactPoint"?: SchemaValue<ContactPoint | IdReference, "contactPoint">
	...
	"hasMemberProgram"?: SchemaValue<
		MemberProgram | IdReference,
		"hasMemberProgram"
	>
	/** Specifies a MerchantReturnPolicy that may be applicable. */
	"hasMerchantReturnPolicy"?: SchemaValue<
	...
	"legalAddress"?: SchemaValue<PostalAddress | IdReference, "legalAddress">
	...
	"legalRepresentative"?: SchemaValue<
		Person | IdReference,
		"legalRepresentative"
	>
	...
	"memberOf"?: SchemaValue<
		MemberProgramTier | Organization | ProgramMembership | IdReference,
		"memberOf"
	>
	/**
...
interface PaymentCardBase extends PaymentMethodBase, FinancialProductBase {
...
interface PaymentMethodBase extends ThingBase {
	...
	"paymentMethodType"?: SchemaValue<
		PaymentMethodType | IdReference,
		"paymentMethodType"
	>
}
...
interface PaymentServiceBase extends PaymentMethodBase, FinancialProductBase {
}
...
interface PersonBase extends ThingBase {
	...
	/** A {@link https://schema.org/Grant Grant} that directly or indirectly provide funding or sponsorship for this item. See also {@link https://schema.org/ownershipFundingInfo ownershipFundingInfo}. */
	"funding"?: SchemaValue<Grant | IdReference, "funding">
	/** Gender of something, typically a {@link https://schema.org/Person Person}, but possibly also fictional characters, animals, etc. While https://schema.org/Male and https://schema.org/Female may be used, text strings are also acceptable for people who are not a binary gender. The {@link https://schema.org/gender gender} property can also be used in an extended sense to cover e.g. the gender of sports teams. As with the gender of individuals, we do not try to enumerate all possibilities. A mixed-gender {@link https://schema.org/SportsTeam SportsTeam} can be indicated with a text value of "Mixed". */
	 ...
	 *
	 * In English, formulations such as "they/them", "she/her", and "he/him" are commonly used online and can also be used here. We do not intend to enumerate all possible micro-syntaxes in all languages. More structured and well-defined external values for pronouns can be referenced using the {@link https://schema.org/StructuredValue StructuredValue} or {@link https://schema.org/DefinedTerm DefinedTerm} values.
	 */
	"pronouns"?: SchemaValue<
		DefinedTerm | StructuredValue | Text | IdReference,
		"pronouns"
	>
	/**
	 * The publishingPrinciples property indicates (typically via {@link https://schema.org/URL URL}) a document describing the editorial principles of an {@link https://schema.org/Organization Organization} (or individual, e.g. a {@link https://schema.org/Person Person} writing a blog) that relate to their activities as a publisher, e.g. ethics or diversity policies. When applied to a {@link https://schema.org/CreativeWork CreativeWork} (e.g. {@link https://schema.org/NewsArticle NewsArticle}) the principles are those of the party primarily responsible for the creation of the {@link https://schema.org/CreativeWork CreativeWork}.
...
interface PostalAddressBase extends ContactPointBase {
	...
	"extendedAddress"?: SchemaValue<Text, "extendedAddress">
	/** The postal code. For example, 94043. */
	"postalCode"?: SchemaValue<Text, "postalCode">
 ...
 *
 * See also {@link https://blog-schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/ blog post}.
 */
...
interface PurchaseTypeLeaf extends EnumerationBase {
	"@type": "PurchaseType"
}
...
interface ServicePeriodBase extends ThingBase {
	/** Days of the week when the merchant typically operates, indicated via opening hours markup. */
	"businessDays"?: SchemaValue<
		DayOfWeek | OpeningHoursSpecification | IdReference,
		"businessDays"
	>
...
interface ServicePeriodLeaf extends ServicePeriodBase {
	"@type": "ServicePeriod"
}
...
export type ServicePeriod = ServicePeriodLeaf
...
interface ShippingConditionsBase extends ThingBase {
	/** The depth of the item. */
	"depth"?: SchemaValue<Distance | QuantitativeValue | IdReference, "depth">
	/** Indicates when shipping to a particular {@link https://schema.org/shippingDestination shippingDestination} is not available. */
	"doesNotShip"?: SchemaValue<Boolean, "doesNotShip">
	...
	"numItems"?: SchemaValue<QuantitativeValue | IdReference, "numItems">
	/** Minimum and maximum order value for which these shipping conditions are valid. */
	"orderValue"?: SchemaValue<MonetaryAmount | IdReference, "orderValue">
	/** Limited period during which these shipping conditions apply. */
	"seasonalOverride"?: SchemaValue<
		OpeningHoursSpecification | IdReference,
		"seasonalOverride"
	>
	/** indicates (possibly multiple) shipping destinations. These can be defined in several ways, e.g. postalCode ranges. */
	 ...
	 *
	 * In the context of {@link https://schema.org/ShippingDeliveryTime ShippingDeliveryTime}, use the {@link https://schema.org/QuantitativeValue QuantitativeValue}. Typical properties: minValue, maxValue, unitCode (d for DAY).
	 *
	 * In the context of {@link https://schema.org/ShippingConditions ShippingConditions}, use the {@link https://schema.org/ServicePeriod ServicePeriod}. It has a duration (as a {@link https://schema.org/QuantitativeValue QuantitativeValue}) and also business days and a cut-off time.
	 */
	"transitTime"?: SchemaValue<
		QuantitativeValue | ServicePeriod | IdReference,
		"transitTime"
	>
	/** The weight of the product or person. */
	"weight"?: SchemaValue<Mass | QuantitativeValue | IdReference, "weight">
...
interface ShippingConditionsLeaf extends ShippingConditionsBase {
...
export type ShippingConditions = ShippingConditionsLeaf
interface ShippingDeliveryTimeBase extends ThingBase {
	 ...
	 * The typical delay between the receipt of the order and the goods either leaving the warehouse or being prepared for pickup, in case the delivery method is on site pickup.
	 *
	 * In the context of {@link https://schema.org/ShippingDeliveryTime ShippingDeliveryTime}, Typical properties: minValue, maxValue, unitCode (d for DAY). This is by common convention assumed to mean business days (if a unitCode is used, coded as "d"), i.e. only counting days when the business normally operates.
	 *
	 * In the context of {@link https://schema.org/ShippingService ShippingService}, use the {@link https://schema.org/ServicePeriod ServicePeriod} format, that contains the same information in a structured form, with cut-off time, business days and duration.
	 */
	"handlingTime"?: SchemaValue<
		QuantitativeValue | ServicePeriod | IdReference,
		"handlingTime"
	>
	/**
...
interface ShippingRateSettingsBase extends ThingBase {
	...
	"orderPercentage"?: SchemaValue<Number, "orderPercentage">
	/** indicates (possibly multiple) shipping destinations. These can be defined in several ways, e.g. postalCode ranges. */
	"shippingDestination"?: SchemaValue<
		DefinedRegion | IdReference,
		"shippingDestination"
	...
	"weightPercentage"?: SchemaValue<Number, "weightPercentage">
}
...
interface ShippingServiceBase extends ThingBase {
	/** Type of fulfillment applicable to the {@link https://schema.org/ShippingService ShippingService}. */
	"fulfillmentType"?: SchemaValue<
		FulfillmentTypeEnumeration | IdReference,
		"fulfillmentType"
	>
	/**
	 * The typical delay between the receipt of the order and the goods either leaving the warehouse or being prepared for pickup, in case the delivery method is on site pickup.
	...
	"handlingTime"?: SchemaValue<
		...
		"handlingTime"
	>
	/** The conditions (constraints, price) applicable to the {@link https://schema.org/ShippingService ShippingService}. */
	"shippingConditions"?: SchemaValue<
		ShippingConditions | IdReference,
		"shippingConditions"
	>
	/** The membership program tier an Offer (or a PriceSpecification, OfferShippingDetails, or MerchantReturnPolicy under an Offer) is valid for. */
	"validForMemberTier"?: SchemaValue<
...
interface SportsEventBase extends EventBase {
	...
	"referee"?: SchemaValue<Person | IdReference, "referee">
...
export type TierBenefitEnumeration =
