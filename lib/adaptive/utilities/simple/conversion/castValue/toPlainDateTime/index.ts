 ...
 */
const toPlainDateTime = (value: DateTimeInput | null | undefined): Temporal.PlainDateTime | null => {
	...
	if (typeof value === "object" && 
		...
		try {
			...
			return Temporal.PlainDateTime.from(value as PlainDateTimeLike, { overflow: 'reject' })
		} catch {
			return null
		}
	}
