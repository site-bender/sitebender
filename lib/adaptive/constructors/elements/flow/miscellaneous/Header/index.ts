...
import type { HeaderAttributes } from "../../../types/attributes/index.ts"
...
import { HEADER_NOT_IN_SECTIONING_ROLES } from "../../../constants/aria-roles.ts"
 ...
 */
export const filterAttributes = (attributes: HeaderElementAttributes) => {
	const {
		id,
		// ARIA attributes
