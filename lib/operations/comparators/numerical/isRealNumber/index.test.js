...
test("[isRealNumber] (calculations::comparators::numerical) returns Left(Array(Errors)) when bad operand", async () => {
	expect(
		await isRealNumber(IsRealNumber(Constant("RealNumber")()))(),
	).toMatchObject({
		left: [
			{
				tag: "Error",
