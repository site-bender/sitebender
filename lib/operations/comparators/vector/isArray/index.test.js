...
test("[isArray] (calculations::comparators::numerical) returns Left(Array(Errors)) when bad operand", async () => {
	expect(await isArray(IsArray(Constant("Array")()))()).toMatchObject({
		left: [
			{
				tag: "Error",
