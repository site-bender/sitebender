...
test("[isYearWeek] (calculations::comparators::temporal) returns Left(Array(Errors)) when bad operand", async () => {
	expect(await isYearWeek(IsYearWeek(Constant("YearWeek")()))()).toMatchObject({
		left: [
			{
				tag: "Error",
