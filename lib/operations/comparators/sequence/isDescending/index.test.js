...
test("[isDescending] (calculations::comparators::numerical) returns Left(Array(Errors)) when bad operand", async () => {
	expect(await isDescending(IsDescending(Constant("Array")()))()).toMatchObject(
		{
			left: [
				{
					tag: "Error",
