...
test("[isMember] (calculations::comparators::set) returns Left(Array(Errors)) when bad operand", async () => {
	expect(
		await isMember(
			IsMember("Member")(Constant("String")())(
				Constant("Array")(["red", "green", "blue"]),
			),
		)(),
	).toMatchObject({
...
test("[isMember] (calculations::comparators::set) returns Left(Array(Errors)) when bad test", async () => {
	expect(
		await isMember(
			IsMember("Member")(Constant("String")("blue"))(Constant("Array")()),
		)(),
	).toMatchObject({
		left: [
			{
