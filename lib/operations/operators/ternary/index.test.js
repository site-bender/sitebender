...
test("[ternary] (operations::operators) returns Left(Array(Errors)) on bad condition", async () => {
...
test("[ternary] (operations::operators) returns Left(Array(Errors)) on bad ifTrue", async () => {
...
test("[ternary] (operations::operators) returns Left(Array(Errors)) on bad ifFalse", async () => {
