...
test("[proportionedRate] (calculations::operators) returns Left(Array(Errors)) on bad table", async () => {
		...
		left: [
			{
				tag: "Error",
				message:
					"Failed to parse JSON table: SyntaxError: Expected ',' or ']' after array element in JSON at position 3",
				operation: {
...
test("[proportionedRate] (calculations::operators) returns Left(Array(Errors)) when table not array", async () => {
...
test("[proportionedRate] (calculations::operators) returns Left(Array(Errors)) on missing table", async () => {
	const op = ProportionedRate()(Constant("Json")())(Constant()(7_600_000))
...
test("[proportionedRate] (calculations::operators) returns Left(Array(Errors)) on bad amount", async () => {
