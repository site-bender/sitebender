...
const proportionedRate = op => async (arg, localValues) => {
	const table = await composeOperators(op.table)(arg, localValues)
	const amount = await composeOperators(op.amount)(arg, localValues)
