...
test("[hyperbolicTangent] (operations::operators) gets the hyperbolicTangent", async () => {
...
test("[hyperbolicTangent] (operations::operators) returns Left(Array(Errors)) on bad operand", async () => {
