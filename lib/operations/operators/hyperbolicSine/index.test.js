...
test("[hyperbolicSine] (calculations::operators) gets the hyperbolicSine", async () => {
...
test("[hyperbolicSine] (calculations::operators) returns Left(Array(Errors)) on bad operand", async () => {
