...
test("[arcHyperbolicSine] (operations::operators) gets the arcHyperbolicSine", async () => {
...
test("[arcHyperbolicSine] (operations::operators) returns Left(Array(Errors)) on bad operand", async () => {
