...
test("[hypotenuse] (calculations::operators) returns Left(Array(Errors)) for empty array of operands", async () => {
	const op = Hypotenuse("Number")([])
...
test("[hypotenuse] (calculations::operators) returns Left(Array(Errors)) on bad operand", async () => {
	const op = Hypotenuse("Number")([
		Constant("Number")(3),
		Constant("Number")(),
		Constant("Number")(5),
