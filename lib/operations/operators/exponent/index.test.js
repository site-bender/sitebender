...
test("[exponent] (operations::operators) gets the exponent of 1", async () => {
	const op = Exponent("Number")(Constant("Number")(1))

	expect(await exponent(op)()).toMatchObject({ right: 2.718281828459045 })
})

test("[exponent] (operations::operators) gets the exponent of 0", async () => {
...
test("[exponent] (operations::operators) returns Left(Array(Errors)) on bad operand", async () => {
