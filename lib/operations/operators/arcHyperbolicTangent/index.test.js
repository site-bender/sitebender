...
test("[arcHyperbolicTangent] (operations::operators) gets the arcHyperbolicTangent", async () => {
...
test("[arcHyperbolicTangent] (operations::operators) returns Left(Array(Errors)) on bad operand", async () => {
