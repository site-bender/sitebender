...
**CRITICAL: Use toolkit types instead of `unknown`:**
...
import gte from "libraries/toolkit/src/vanilla/validation/gte/index.ts"
import lte from "libraries/toolkit/src/vanilla/validation/lte/index.ts"
...
import isInfinite from "libraries/toolkit/src/vanilla/validation/isInfinite/index.ts"
import isNegativeInfinity from "libraries/toolkit/src/vanilla/validation/isNegativeInfinity/index.ts"
import isZero from "libraries/toolkit/src/vanilla/validation/isZero/index.ts"
import or from "libraries/toolkit/src/vanilla/logic/or/index.ts"
import and from "libraries/toolkit/src/vanilla/logic/and/index.ts"
import not from "libraries/toolkit/src/vanilla/logic/not/index.ts"
import isNullish from "libraries/toolkit/src/vanilla/validation/isNullish/index.ts"
...
// CORRECT - Use toolkit comparison functions
...
// CORRECT - Use toolkit predicates
if (isInfinite(value)) { ... }
if (isNegativeInfinity(value)) { ... }
if (isNaN(value)) { ... }  // If this is toolkit's isNaN, OK
```
...
If you encounter a pattern that SHOULD have a toolkit function but doesn't exist in the inventory:
...
import is from "libraries/toolkit/src/vanilla/validation/is/index.ts"
