...
- [ ] **Update toolkit inventory**: Run `deno task update-toolkit-inventory`
...
- [ ] Replace with existing toolkit functions
...
### Missing Functions
- [ ] If toolkit function doesn't exist, STOP and report
...
- [ ] All toolkit functions have proper imports
...
2. Toolkit type imports
3. Toolkit function imports (grouped by category)
4. Local imports
...
- [ ] NOT creating new functions when toolkit has equivalent
...
4. Note any functions that should be added to toolkit
