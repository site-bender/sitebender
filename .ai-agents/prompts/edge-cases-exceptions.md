...
1. **Missing Toolkit Function**: A function that logically should exist doesn't (e.g., `isPositiveInfinity`)
...
6. **STOP if function missing** - Don't work around missing toolkit functions
