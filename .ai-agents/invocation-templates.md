...
Target folder: libraries/toolkit/src/vanilla/array
```
...
Target folder: libraries/toolkit/src/vanilla/conversion
```
...
Target folder: libraries/toolkit/src/vanilla/string
```
