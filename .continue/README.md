...
- Use one worktree (e.g., `ai/toolkit`) with local DeepSeek agents and assign well-scoped, parallel tasks to other worktrees using cloud agents (imports-only, tests-only, or final reviewer). Keep scopes tight to reduce conflicts.
