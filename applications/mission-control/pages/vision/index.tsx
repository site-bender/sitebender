export default function Vision() {
	return (
		<body>
			...
			<h2>MVP Timing</h2>
			<p>
				Ship the current end-to-end MVP first (compiler, runtime, the-workshop).
				Immediately afterward, start the docs MVP:
			</p>
			<ol>
				<li>
					Define component metadata schema and template manifest format.
				</li>
				<li>
					Implement a component registry and generate API docs from it.
				</li>
