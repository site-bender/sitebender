...
const preCommitContent = [
	...
	"set -euo pipefail",
	"",
	"# Note: toolsmith commit restriction removed (ALLOW_TOOLSMITH no longer required)",
	"",
	...
	"fi",
	"",
	'echo "[hooks] Running strict FP checks (architect, codewright) ..."',
	...
	"fi",
	"",
	"deno task fp:architect",
	"",
	"deno task fp:codewright",
	"",
