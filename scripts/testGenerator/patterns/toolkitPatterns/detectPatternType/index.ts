/**
 * Detect which toolkit patterns apply to a function
 */
...
/**
 * Detect which toolkit patterns apply to a function based on its signature
 * @param signature Function signature
 * @returns Array of applicable patterns
 */
export default function detectPatternType(
	signature: FunctionSignature
): Array<ToolkitPattern> {
	const patterns: Array<ToolkitPattern> = []
