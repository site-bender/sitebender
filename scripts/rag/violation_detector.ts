 ...
 */
export default function detectViolations(code: string): ReadonlyArray<Violation> {
 ...
 */
export function formatViolationReport(violations: ReadonlyArray<Violation>): string {
