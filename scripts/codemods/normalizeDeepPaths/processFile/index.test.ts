...
import type { Component } from "libraries/codewright/types"
`
		await Deno.writeTextFile(filePath, content)
...
export { another } from "libraries/codewright/src/base"
`
		await Deno.writeTextFile(filePath, content)
		...
		assertEquals(result.includes('"libraries/codewright/src'), false)
	})
...
export * from "libraries/codewright/types"
