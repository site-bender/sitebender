...
Deno.test("categorizeImport", async function testCategorizeImport(t) {
	...
	await t.step("categorizes project components imports", function testComponents() {
		assertEquals(categorizeImport("~components/Button"), "components")
		assertEquals(categorizeImport("~components/forms/Input"), "components")
		assertEquals(categorizeImport("~components/layout/Header"), "components")
	})
	...
	await t.step("handles edge cases", function testEdgeCases() {
		...
		assertEquals(categorizeImport("~COMPONENTS/Button"), "external") // All caps
	})
	...
	await t.step("preserves exact categorization rules", function testExactRules() {
		...
		assertEquals(categorizeImport("~components/very/deep/nested/component"), "components")
	})
})
