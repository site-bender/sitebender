...
Deno.test("removeDuplicateImports", async function testRemoveDuplicateImports(t) {
	...
	await t.step("preserves imports with different types", function testDifferentTypes() {
		const imports: ImportInfo[] = [
			{
				type: "value",
				source: "./module",
	...
	await t.step("preserves imports with different sources", function testDifferentSources() {
		const imports: ImportInfo[] = [
			{
				type: "value",
				source: "./module1",
	...
	await t.step("preserves imports with different text", function testDifferentText() {
		const imports: ImportInfo[] = [
			{
				type: "value",
				source: "./module",
	...
	await t.step("handles multiple duplicates", function testMultipleDuplicates() {
		const imports: ImportInfo[] = [
			{
				type: "value",
				source: "./module1",
	...
	await t.step("preserves order of first occurrences", function testPreservesOrder() {
		const imports: ImportInfo[] = [
			{
				type: "value",
				source: "./third",
