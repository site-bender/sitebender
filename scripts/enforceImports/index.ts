...
import isEmpty from "@sitebender/toolkit/vanilla/array/isEmpty/index.ts"
...
export default async function enforceImports(rootsArg: Array<string> = Deno.args): Promise<void> {
