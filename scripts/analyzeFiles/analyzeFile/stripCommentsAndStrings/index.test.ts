...
Deno.test("stripCommentsAndStrings", async function testStripCommentsAndStrings(t) {
	await t.step("removes single line comments", function testSingleLineComments() {
	...
	await t.step("removes multi line comments", function testMultiLineComments() {
