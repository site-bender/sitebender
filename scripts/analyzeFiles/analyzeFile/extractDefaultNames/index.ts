...
export default function extractDefaultNames(matches: Array<RegExpExecArray>): Array<string> {
	return reduce<RegExpExecArray, Array<string>>(
		function addDefaultName(acc: Array<string>, match: RegExpExecArray): Array<string> {
